sub configurarBuild {
    my %configsBuild = (
        ...
        skillsClasse1T => 'AC_OWL 10, AC_VULTURE 10, AC_CONCENTRATION 10, AC_DOUBLE 10, AC_SHOWER 10',
        skillsClasse2T => 'BA_MUSICALLESSON 10, BD_ADAPTATION 1, BD_ENCORE 1, BA_FROSTJOKE 5, BA_MUSICALSTRIKE 5, CG_ARROWVULCAN 10, BA_DISSONANCE 5, BA_ASSASSINCROSS 10, BA_POEMBRAGI 10, BD_SIEGFRIED 3, BD_RICHMANKIM 5, BA_APPLEIDUN 2, CG_MARIONETTE 1, CG_TAROTCARD 3',
        skillsClasse3 => '',
